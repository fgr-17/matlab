...
%
%   funcion h = eliminabanda_ideal (wc1, wc2, N )
% 
%   Parámetros de Entrada :
%
%       wc1 : comienzo de la banda de eliminiación del filtro
%       wc2 : final de la banda de eliminación del filtro
...
function [h H] = eliminabanda_ideal (wc1, wc2, N )
...
H( N1 : N2) = zeros(1, N_bandapaso) ;
H( N3 : N4) = zeros(1, N_bandapaso) ;
