...
%
%   Enunciado:  13. Filtrar las señales del ejercicio 6 si la ventana 
%   considerada es:
%
%               w(t) = [w0 / (pi * Fs)]* sinc(w0*t)
%
%   Realizar gráficos y tener en cuenta todas las consideraciones 
...
for i = 1: 3
    ...
    [Wmod tW]= my_Wavelet(fc, f0(i), t0(i), N, Fs);                         % Ventana de análisis
