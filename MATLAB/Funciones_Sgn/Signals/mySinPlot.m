...
hold on;
PlotTiempo(signal, timeAxis, 'Señal interpolada y muestra a muestra', 't - n', 'y(t), y[n]', 0, 'r') ;
PlotTiempo(signal, timeAxis, 'Señal interpolada y muestra a muestra', 't - n', 'y(t), y[n]', 1, 'b') ;
hold off;
end